...
const Shop = () => {
  return (
    <div>
      <section className='w-full bg-yellow-500 px-4 pt-20'>
        <div className="w-full flex flex-col md:flex-row justify-center items-center gap-5">
          <div className="text-field w-full md:w-[45%] flex flex-col justify-center space-y-2 text-center">
            ...
            <div className="appstoreIMG flex gap-2 mt-4 justify-center">
